...
function setSearchModeLeilao(mode) {
    ...
    var byManual = document.getElementById('searchManual');

    byName.style.display   = mode==='name'   ? 'flex'  : 'none';
    byNumber.style.display = mode==='number' ? 'flex'  : 'none';
    byManual.style.display = mode==='manual' ? 'block' : 'none';
...
function addItemManual() {
    ...
    var novoItem = {
        ...
        apiId:    null,
        name:     nome,
        image:    imagem || 'https://images.pokemontcg.io/base1/4_hires.png',
    ...
    saveLeilao(_currentLeilao.id, {itens:itens}, function(){
        ...
        showNotification('✅ "'+nome+'" adicionado manualmente!','success');
    });
}
